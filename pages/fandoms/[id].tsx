...
const Index = ({storiesServer, fandomId}) => {
    ...
    React.useEffect(() => {
        async function fetchMyAPI() {
            ...
            const resp = await axios.get('http://localhost:9000/fandoms/' + fandomId);
            setFandom(resp.data);
            const story = [];
                        ...
                        {stories.map(map => {
                            return (
                                <div
                                    ...
                                    <div className={style.imageStory} onClick={() => router.push('/story/' + map.id)}><img style={{cursor: 'pointer'}}
